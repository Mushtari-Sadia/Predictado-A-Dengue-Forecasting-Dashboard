...
for i, row in input_df.iterrows():
	all_data += [{"Date": row['Date'] ,"Temperature": row['Temperature'],"Precipitation": row['Precipitation'],"City": row['City']}]
...
try:
	...
	forecasts = (json.loads(result.decode('utf-8'))['Results']['forecast'])
	# dfs.append(df)
	# print(forecasts[-1])
